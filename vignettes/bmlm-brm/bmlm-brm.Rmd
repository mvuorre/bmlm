...
```{r prepare-document, include = FALSE}
library(papaja)
library(knitr)
...
```{r template-mediation-plot, echo = F, fig.cap = "Diagram of the mediation model.", fig.height=2.8, fig.width=4.2}
...
knitr::include_graphics("includes/multilevel-mediation.pdf")
```
...
```{r example1-fit, echo = T, results='hide'}
fit <- mlm(d = MEC2010, 
           id = "subj", 
           x = "lag", 
           m = "hr_cw", 
...
```{r example2-fit, echo = T, results='hide'}
...
load("includes/compare-bmlm-mplus.rda") 
