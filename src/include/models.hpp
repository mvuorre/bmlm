...
public:
    model_bmlm(stan::io::var_context& context__,
        ...
        context__.validate_dims("data initialization", "slope_scale", "double", context__.to_vec());
        slope_scale = double(0);
        vals_r__ = context__.vals_r("slope_scale");
        pos__ = 0;
        slope_scale = vals_r__[pos__++];
        context__.validate_dims("data initialization", "intercept_scale", "double", context__.to_vec());
        intercept_scale = double(0);
        vals_r__ = context__.vals_r("intercept_scale");
        pos__ = 0;
        intercept_scale = vals_r__[pos__++];
        ...
        try {
            stan::math::assign(y_mean, mean(Y));
        ...
        try {
            {
                ...
                lp_accum__.add(normal_log<propto__>(dy, 0, intercept_scale));
                lp_accum__.add(normal_log<propto__>(dm, 0, intercept_scale));
                lp_accum__.add(normal_log<propto__>(a, 0, slope_scale));
                lp_accum__.add(normal_log<propto__>(b, 0, slope_scale));
                lp_accum__.add(normal_log<propto__>(cp, 0, slope_scale));
                lp_accum__.add(cauchy_log<propto__>(get_base1(tau,1,"tau",1), 0, tau_scale));
                lp_accum__.add(cauchy_log<propto__>(get_base1(tau,2,"tau",1), 0, tau_scale));
                lp_accum__.add(cauchy_log<propto__>(get_base1(tau,3,"tau",1), 0, tau_scale));
                lp_accum__.add(cauchy_log<propto__>(get_base1(tau,4,"tau",1), 0, tau_scale));
                lp_accum__.add(cauchy_log<propto__>(get_base1(tau,5,"tau",1), 0, tau_scale));
